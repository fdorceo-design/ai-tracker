# Ample Metal Hellrazer — AI Tracker Reference

Updated: 2026-09-08

Evidence priority: official Ample Sound current Main Panel Manual. Raw MIDI Note No. uses **C4 = 60**.

Official manual: https://amplesound.net/en/Main_Panel_Manual-AMH.pdf

## 1. Main articulations / keyswitches

| Abbr. | Articulation | Keyswitch | Raw MIDI Note No. | Playable range | Notes |
|---|---|---:|---:|---|---|
| PH | Pinch Harmonic | B-1 | 11 | instrument range |  |
| Sus | Sustain | C0 | 12 | instrument range |  |
| NH | Natural Harmonic | C#0 | 13 | instrument range |  |
| PM | Palm Mute | D0 | 14 | instrument range | velocity controls mute/dead-note behavior |
...
- Metal-series main-panel manuals use the same core C0–F0 articulation/legato block plus Pinch Harmonic at B-1.
- Some metal-specific velocity behavior and FX labels vary by product; no unverified numeric value has been added.
