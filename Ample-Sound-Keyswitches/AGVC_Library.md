# Ample Guitar VC — AI Tracker Reference

Updated: 2026-09-08

Evidence priority: official Ample Sound current Main Panel Manual. Raw MIDI Note No. uses **C4 = 60**.

Official manual: https://amplesound.net/en/Main_Panel_Manual-AGVC.pdf

## 1. Main articulations / keyswitches

| Abbr. | Articulation | Keyswitch | Raw MIDI Note No. | Playable range | Notes |
|---|---|---:|---:|---|---|
| PH | Pinch Harmonic | B-1 | 11 | E1–D5 |  |
| Sus | Sustain & Pop | C0 | 12 | E1–D5 | vel <127 Sustain; 127 Pop or Pinch Harmonic depending on Settings |
| NH | Natural Harmonic | C#0 | 13 | E1–B4 |  |
| PM | Palm Mute | D0 | 14 | E1–D5 | high velocity Palm Mute; low velocity Dead Note |
| SIO | Slide In & Slide Out | D#0 | 15 | F#1–D5 |  |
| LS | Legato Slide (Poly Legato) | E0 | 16 | F1–D5 |  |
| HP | Hammer-On & Pull-Off | F0 | 17 | E1–D5 |  |
