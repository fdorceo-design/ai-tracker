# Ample Guitar T — AI Tracker Reference

Updated: 2026-09-08

Evidence priority: official Ample Sound current Main Panel Manual. Raw MIDI Note No. uses **C4 = 60**.

Official manual: https://amplesound.net/en/Main_Panel_Manual-AGT.pdf

## 1. Main articulations / keyswitches

| Abbr. | Articulation | Keyswitch | Raw MIDI Note No. | Playable range | Notes |
|---|---|---:|---:|---|---|
| Sus | Sustain & Pop | C0 | 12 | E1–C5 | vel <127 Sustain; 127 Pop |
| NH | Natural Harmonic | C#0 | 13 | E2–B4 |  |
| PM | Palm Mute | D0 | 14 | E1–C5 | lower velocity = greater mute depth |
| SIO | Slide In & Slide Out | D#0 | 15 | F#1–C5 |  |
| LS | Legato Slide (Poly Legato) | E0 | 16 | F1–C5 |  |
| HP | Hammer-On & Pull-Off | F0 | 17 | E1–C5 |  |
| SG | Slide Guitar | F#0 | 18 | F#1–C5 | high velocity = slide ornament; low velocity = sustained slide note |
...
- C0 + D0 together enables the Sustain/Palm-Mute mixed articulation.
