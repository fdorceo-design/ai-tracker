# Ample Bass J (ABJ) — AI Tracker Reference

Updated: 2026-09-08

Evidence priority: official Ample Sound current Main Panel Manual. Raw MIDI Note No. uses **C4 = 60**.

Official manual: https://www.amplesound.net/en/Main_Panel_Manual-ABJ.pdf
...
| PM | Palm Mute | D0 | 14 | E1–D4 | High velocity Palm Mute; low velocity Dead Note |
| SIO | Slide In & Slide Out | D#0 | 15 | F#1–D#4 |  |
...
| A#5 | 82 | FX Slide and Return on string 4 |
| B5 | 83 | FX Slide and Return on string 3 |
| C6 | 84 | FX Slide Down on string 4 |
| C#6 | 85 | FX Slide Down on string 3 |
